...
export function SearchUser() {
  ...
  const { handleFollow, isFollowing, isInProgress, isFollowBack } = useFollow(currentUserId, currentUserId);
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span onClick={() => Navigate(`/profile/${user.id}`)} className="text-white font-semibold cursor-pointer">{user.full_name}</span>
